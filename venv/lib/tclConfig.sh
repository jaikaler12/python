...
# installed.
TCL_PREFIX='/Users/jaideepkaler/python/venv'

# Top-level directory in which Tcl's platform-specific files (e.g.
# executables) are installed.
TCL_EXEC_PREFIX='/Users/jaideepkaler/python/venv'
...
TCL_EXTRA_CFLAGS='-ftree-vectorize -fPIC -fPIE -fstack-protector-strong -O2 -pipe -isystem /Users/jaideepkaler/python/venv/include -fdebug-prefix-map=/var/folders/nz/j6p8yfhx1mv_0grj5xl4650h0000gp/T/abs_99lesisxvl/croot/tk_1748849401842/work=/usr/local/src/conda/tk-8.6.14 -fdebug-prefix-map=/Users/jaideepkaler/python/venv=/usr/local/src/conda-prefix -pipe  -D_FORTIFY_SOURCE=2 -isystem /Users/jaideepkaler/python/venv/include -mmacosx-version-min=11.1 '
...
TCL_LD_FLAGS='-Wl,-pie -Wl,-headerpad_max_install_names -Wl,-dead_strip_dylibs -Wl,-rpath,/Users/jaideepkaler/python/venv/lib -L/Users/jaideepkaler/python/venv/lib -headerpad_max_install_names -Wl,-search_paths_first '
...
# String to pass to linker to pick up the Tcl library from its
# installed directory.
TCL_LIB_SPEC='-L/Users/jaideepkaler/python/venv/lib -ltcl8.6'

# String to pass to the compiler so that an extension can
# find installed Tcl headers.
TCL_INCLUDE_SPEC='-I/Users/jaideepkaler/python/venv/include'
...
TCL_PACKAGE_PATH='{/Users/jaideepkaler/python/venv/lib} '
...
# String to pass to linker to pick up the Tcl stub library from its
# installed directory.
TCL_STUB_LIB_SPEC='-L/Users/jaideepkaler/python/venv/lib -ltclstub8.6'
...
TCL_STUB_LIB_PATH='/Users/jaideepkaler/python/venv/lib/libtclstub8.6.a'
